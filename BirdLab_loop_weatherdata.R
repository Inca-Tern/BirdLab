...
ToGetGSODRData{
  ...
  write.csv(GSODR_data_all,file="~/BirdLab/data/files_output/GSODR_data_all_1.csv")
  write.csv(GSODR_data_all,file="~/BirdLab/data/files_output/GSODR_data_all_2.csv")
  GSODR_data_2 <- read.csv("~/BirdLab/data/files_output/GSODR_data_all_2.csv",header=TRUE,sep=",")
